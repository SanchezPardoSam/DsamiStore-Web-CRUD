...
public class ProveedorControlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (accion.equals("regiones")) {
            ...
            regionesPorPais = proveedor.listarRegiones(paisId);
        ...
        if (accion.equals("provincias")) {
            ...
            provinciasPorPais = proveedor.listarProvincias(regionId);
        ...
        if (accion.equals("distritos")) {
            ...
            distritosPorPais = proveedor.listarDistritos(provinciaId);
        ...
        if (accion.equals("Editar")) {
            ...
            proveedor.modificarProveedor(id, nombre, apellidoPaterno, apellidoMaterno, idTipoDocumento, numDocumento, fechaNac, pais, region, provincia, distrito, direccion);
            acceso = index;
        ...
        if (accion.equals("Crear")) {
            ...
            proveedor.agregarProveedor(empresa, nombre, apellidoPaterno, apellidoMaterno, idTipoDocumento, numDocumento, fechaNac, pais, region, provincia, distrito, direccion);
