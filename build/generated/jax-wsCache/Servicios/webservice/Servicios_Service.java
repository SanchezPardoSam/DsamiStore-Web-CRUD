 ...
 * 
 */
@WebServiceClient(name = "Servicios", targetNamespace = "http://WebService/", wsdlLocation = "http://localhost:8080/DsamiStore-Web/Servicios?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/DsamiStore-Web/Servicios?wsdl");
